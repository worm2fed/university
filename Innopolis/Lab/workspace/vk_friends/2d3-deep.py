...
class D3(VkFriends):
	...
	def __init__(self, token, my_id, api_v, deep):
		VkFriends.__init__(self, token, my_id, api_v, deep)
		self.friendships = self.deep_friends(deep)
		self.js = {"nodes": [], "links": []}
